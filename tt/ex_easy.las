...
someone_is_at(Da, Dl) :- distance_from_agent(Da), limit(Dl), Da = Dl.   %valuto di toglierlo
...
#modeb(1, someone_is_at(var(distance_from_agent), const(limit))).       %valuto di toglierlo
